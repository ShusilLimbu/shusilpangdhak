...
const Header=(props)=>{
    return(
        ...
        <a href="./src/assets/a.png"><img src='./assets/a.png' alt="Shusil Pangdhak"/></a>
            <div>
            <p>Shusil Pangdhak</p>
            <span>React Js Developer</span>
            </div>
            <a href='https://github.com/ShusilLimbu'><img className='github' src='./assets/github.png'></img></a>
